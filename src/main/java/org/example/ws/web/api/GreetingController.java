...
public class GreetingController {
	...
	static {
		...
		g1.setText("Greetings from Oracle");
		save(g1);

		Greeting g2 = new Greeting();
		g2.setText("Greetings from Amazon");
		save(g2);
	}
	...
	@RequestMapping(value = "/api/greeting/{id}", method = RequestMethod.DELETE, consumes = MediaType.APPLICATION_JSON_VALUE)
